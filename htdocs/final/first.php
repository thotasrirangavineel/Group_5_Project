...
<p>This site belongs to IITI</p>
  ...
  <a href="bsbe.iiti.ac.in" class="button">Mainsite</a>
	...
	<br><p> -This site is to help you to book slot for the equipment available in the FACS and confocal lab, note that booking can only be done for tomorrow and its following days</p>
        <br><p> -New users must enter your details and register your account</p>
        <br><p> -Old users can just login using their email id to book </p>
        <br><P> -Please enter your email id and submit, then select the machine in next page and finally in its next page select date and time slot</p>
        <br><p> -After booking slot you will receive a mail regarding payment. Click the link and pay accordingly</p>
